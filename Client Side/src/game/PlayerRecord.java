...
public class PlayerRecord extends BorderPane {
...
//        System.out.println("MySymbol"+beginBase.client.id);   
    ...
    void drawSymbol(String message) {
        ...
        switch (arrOfStr[0]) {
            case "1":
                locations[0].setText(arrOfStr[1]);
                break;
            case "2":
                locations[1].setText(arrOfStr[1]);
                break;
            case "3":
                locations[2].setText(arrOfStr[1]);
                break;

            case "4":
                locations[3].setText(arrOfStr[1]);
                break;
            case "5":
                locations[4].setText(arrOfStr[1]);
                break;
            case "6":
                locations[5].setText(arrOfStr[1]);
                break;
            case "7":
                locations[6].setText(arrOfStr[1]);
                break;
            case "8":
                locations[7].setText(arrOfStr[1]);
                break;
            case "9":
    ...
    void rePlayGame(String s) {
        ...
        currentplayer.setText("X");
        finished = false;
        String[] arrOfStr = myRecord.split("\\:");
        i = 1;
        TimerTask myTask;
